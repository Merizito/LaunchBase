...
for (let card of cards) {
    card.addEventListener("click", function(){
        ...
        if(curso == 'starter'){
            ...
            closeModal.setAttribute("style", "color: black")
            maximizeModal.setAttribute("style", "color: black")
            closeModal.addEventListener("mouseover", function(){

                closeModal.setAttribute("style", "color: grey")
            })
            ...
            maximizeModal.addEventListener("mouseover", function(){
                maximizeModal.setAttribute("style", "color: grey")
            })
